...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(30, 80, 530, 223);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 40)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("LOGIN PAGE");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(150, 10, 410, 60);

        jLabel3.setForeground(new java.awt.Color(0, 51, 51));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cab/2560x1440-midnight-green-solid-color-background.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 0, 590, 320);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if( jTextField1.getText().equals("admin") && jPasswordField1.getText().equals("000")) 
        {
            JOptionPane.showMessageDialog(this, "Login Successfully..");
            this.setVisible(false);
            Cab_Management_System ob=new Cab_Management_System();
            ob.setVisible(true);
        } else {
