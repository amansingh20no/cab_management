...
public class Customer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(230, 10, 268, 50);

        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel1.setText("ID Proof  Number");
        ...
        jPanel1.setBounds(14, 80, 630, 280);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            st.executeUpdate("insert into CustomerTb values("+ jTextField1.getText() +",'"+ jTextField2.getText() +"','"+ jTextField3.getText() +"','"+ jTextField4.getText() +"')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/Busdb?user=root&password=");
            java.sql.Statement st=con.createStatement();
            st.executeUpdate("update CustomerTb set customer='"+ jTextField2.getText() +"',address='"+ jTextField3.getText() +"',phone='"+ jTextField4.getText() +"' where ID="+ jTextField1.getText() +"");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/Busdb?user=root&password=");
            java.sql.Statement st=con.createStatement();
            ResultSet rs=  st.executeQuery("select * from CustomerTb where ID="+ jTextField8.getText() +"");
            int c=0;
            while(rs.next()) {
