...
public class Driver extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(8, 90, 620, 470);

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Driver Detail");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(230, 20, 260, 50);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cab/2560x1440-midnight-green-solid-color-background.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs=  st.executeQuery("select * from DriverTb");
            int c=0;
            while(rs.next())
            {
                c++;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/Busdb?user=root&password=");
            java.sql.Statement st=con.createStatement();
            st.executeUpdate("insert into DriverTb values("+ jTextField1.getText() +",'"+ jTextField2.getText() +"','"+ jTextField3.getText() +"','"+ jTextField4.getText() +"','"+ jTextField5.getText() +"','"+ jTextField6.getText() +"','"+ jTextField7.getText() +"')");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/Busdb?user=root&password=");
            java.sql.Statement st=con.createStatement();
            st.executeUpdate("update DriverTb set Drivername='"+ jTextField2.getText() +"',address='"+ jTextField3.getText() +"',phone='"+ jTextField4.getText() +"',gender='"+ jTextField5.getText() +"',salary='"+ jTextField6.getText() +"',doj='"+ jTextField7.getText() +"' where ID="+ jTextField1.getText() +"");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3325/Busdb?user=root&password=");
            java.sql.Statement st=con.createStatement();
            ResultSet rs=  st.executeQuery("select * from DriverTb where ID="+ jTextField8.getText() +"");
            int c=0;
            while(rs.next()) {
